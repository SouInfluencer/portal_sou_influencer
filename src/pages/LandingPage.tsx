...
import { Users, Building2, ArrowRight, Star, Sparkles, Globe2, Rocket, Shield, ChevronRight, BarChart2, Award, CheckCircle, MessageSquare, Menu, X } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto mb-16">
          ...
          <button
            ...
            className={`group relative rounded-2xl border-2 p-5 sm:p-8 hover:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl touch-manipulation ${
            ...
            <div className="flex flex-col items-start text-left">
              <div className="flex items-center justify-between w-full mb-4 sm:mb-6 gap-4">
                ...
                <div className="flex items-center min-h-[44px]">
                  <span className="text-sm font-medium text-indigo-600 mr-2">Escolher</span>
                  <ChevronRight className={`h-5 w-5 text-indigo-500 transform transition-transform duration-300 ${
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">Quero me conectar com marcas e criar conteúdo patrocinado</p>
              
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center">
                  <Star className="h-5 w-5 text-amber-400 mr-2" />
                  <span className="text-sm sm:text-base text-gray-600">Receba propostas de marcas relevantes</span>
                </div>
                <div className="flex items-center">
              ...
              <div className="mt-6 w-full">
                <div className="flex items-center justify-between p-4 rounded-lg bg-indigo-50 border border-indigo-100">
                  <span className="text-sm text-indigo-600 font-medium">Comissão zero</span>
                  <span className="text-xs text-indigo-500">Plano Gratuito</span>
                </div>
              </div>
            </div>
            {/* Hover Effect */}
          ...
          >
            <div className="flex flex-col items-start text-left">
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">Busco influenciadores para promover minha marca ou produto</p>
