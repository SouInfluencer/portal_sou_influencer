...
import type { WaitlistFormData } from '../../../components/types/waitlist.ts';
import { PostValueCalculator } from '../../../components/PostValueCalculator.tsx';
import { WaitlistForm } from '../../../components/WaitlistForm.tsx';
import { useAnalytics } from '../../../components/hooks/useAnalytics.ts';
import { SuccessModal } from '../../../components/SuccessModal.tsx';
import { useCommunityStats } from '../../../components/hooks/useCommunityStats.ts';
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
          ...
          <header className="relative z-20 container mx-auto px-4 py-6">
            ...
            <div className="text-center py-12 md:py-32 px-4">
              <h1 className="text-4xl md:text-7xl font-bold mb-6 text-white leading-tight">
                Sua Influência Tem Valor
              </h1>
              <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto mb-12">
                Do micro ao macro influenciador, aqui todo criador de conteúdo tem espaço.
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-6 md:p-8">
              <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">
                Calcule o Valor da Sua Influência
              </h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <p className="text-gray-600">
                    Descubra quanto você pode ganhar com suas publicações! Nossa calculadora estima seus
                    ganhos com base no número de seguidores e no formato do conteúdo.
                  </p>
                ...
                <div>
                  <PostValueCalculator followersCount={followersCount || 0}/>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="benefits" className="container mx-auto px-4 py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div
              ...
              <p className="text-gray-600 mb-4">
                Os pagamentos são feitos de forma rápida e protegida, garantindo segurança para influenciadores e
                anunciantes.
              </p>
              <ul className="space-y-3 text-sm text-gray-500">
                <li className="flex items-center gap-2">
            ...
            <div
              ...
              <p className="text-gray-600 mb-4">
                Nosso sistema encontra as melhores parcerias para você, conectando influenciadores e anunciantes que
                realmente combinam.
              </p>
              <ul className="space-y-3 text-sm text-gray-500">
                <li className="flex items-center gap-2">
        ...
        <section id="waitlist" className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto">
            <div
                className="bg-gradient-to-br from-white to-blue-50/50 rounded-3xl p-8 md:p-16 shadow-2xl relative overflow-hidden border border-white/50">
              {/* ... conteúdo existente do background ... */}

              <div className="relative z-10">
                <div className="text-center max-w-2xl mx-auto mb-12">
          <span
              className="inline-flex items-center px-6 py-2 bg-gradient-to-r from-blue-100 to-blue-100 text-blue-600 rounded-full text-sm font-medium mb-6 gap-2 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer group">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex -space-x-3 overflow-hidden relative">
                      ...
                      {totalMembers > recentMembers.length && (
                          <div
                              className="w-10 h-10 rounded-full border-2 border-white bg-blue-50 flex items-center justify-center text-sm font-medium text-blue-600 shadow-md hover:scale-110 transition-transform duration-300">
                            +{totalMembers - recentMembers.length}
                          </div>
                      )}
                    </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
              ...
              <div className="flex flex-col items-start">
                <h3 className="text-xl font-semibold mb-4">Lançamento em:</h3>
                <ul className="space-y-2">
                  ...
                  <span className="text-4xl md:text-5xl font-bold text-white">
                    {String(value).padStart(2, '0')}
                          ...
                          <span className="text-white text-sm md:text-base uppercase mt-1 md:mt-0">{interval}
                            {value !== 1 && 's'}
                  </span>
                        </div>
                    ))}
