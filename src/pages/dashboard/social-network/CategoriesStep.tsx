  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-3">Selecione suas Categorias</h2>
        <p className="text-lg text-gray-600">
          Escolha as categorias de conteúdo que você produz no {platform}
        </p>
      </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <Feature 
                  ...
                  description="Receba campanhas específicas desta categoria"
                />
                <Feature 
                  title="Métricas Específicas" 
                  description="Acompanhe seu desempenho na categoria"
                />
              </div>
            </div>
          </button>
