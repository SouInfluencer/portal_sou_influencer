    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {profile.recentCampaigns.map((campaign: any, index: number) => (
          <div
            key={index}
            className="group bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
          >
            <div className="p-6">
              ...
              <div className="grid grid-cols-3 gap-4 py-4 border-y border-gray-100">
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-900">{campaign.performance.views}</p>
                  <p className="text-xs text-gray-500">Visualizações</p>
                </div>
                <div className="text-center">
                  <Heart className="h-5 w-5 text-gray-400 mx-auto mb-1" />
                  <p className="text-sm font-medium text-gray-900">{campaign.performance.engagement}</p>
                  <p className="text-xs text-gray-500">Engajamento</p>
                </div>
                <div className="text-center">
                  <ChevronRight className="h-5 w-5 text-gray-400 mx-auto mb-1" />
                  <p className="text-sm font-medium text-gray-900">{campaign.performance.clicks}</p>
