              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <input
                    ...
                    className="inline-flex items-center px-3 py-1 rounded-full text-sm border border-dashed border-gray-300 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                    onKeyPress={(e) => {
                      if (e.key === 'Enter') {
                        e.preventDefault();
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
          ...
          <div className="grid gap-6">
            {profile.expertise.map((item: any, index: number) => (
              <div key={index} className="flex items-start p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
