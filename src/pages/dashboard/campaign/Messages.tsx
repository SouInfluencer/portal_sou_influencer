...
export function CampaignMessages({ campaign }: CampaignMessagesProps) {
  ...
  return (
    <div className="flex flex-col h-[600px] bg-gradient-to-b from-gray-50/50 to-white rounded-lg border border-gray-200/80">
      {/* Messages List */}
              ...
              <div className={`flex max-w-lg ${
                ...
                <div className={`mx-2 ${
                  message.sender === 'Você'
                    ...
                    : 'bg-white'
                } rounded-xl px-4 py-3 shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-100`}>
                  {message.sender !== 'Você' && (
                  ...
                  {message.attachments?.map((attachment, index) => (
                    <div
                      key={index}
                      className="mt-3 flex items-center p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200 group cursor-pointer"
                    >
                      {attachment.type === 'pdf' ? (
