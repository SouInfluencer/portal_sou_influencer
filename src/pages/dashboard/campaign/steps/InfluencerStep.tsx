...
import { Search, Filter, Users, MapPin, ChevronRight, DollarSign, Star, Info, Award, Clock, CheckCircle, Instagram, Youtube, Video, BarChart2, Heart, MessageSquare, X, AlertTriangle } from 'lucide-react';
import type { Platform, ContentType, Influencer } from '../types';
import { calculateInfluencerPrice, formatCurrency } from '../utils';
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            {Object.values(filters).some(val => 
              Array.isArray(val) ? val.length > 0 : val !== undefined && val !== platform
            ) && (
