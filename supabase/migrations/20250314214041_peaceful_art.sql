/*
  ...
  1. New Columns
    - `validation_image` (text) - Image URL for validation post
    - `validation_caption` (text) - Caption text for validation post
    - `validation_instructions` (text) - Instructions for validation process

  2. Changes
    - Add new validation fields to social_networks table
    - Update status check constraint with validation states
    - Add service_role access for validation operations
