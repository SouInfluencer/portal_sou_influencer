/*
  # Add influencer progress tracking fields

  1. New Columns
    - Progress tracking fields for campaign_influencers
    - Engagement metrics and validation data
    - Timestamps for each stage

  2. Changes
    - Add status tracking for individual influencers
    - Add automatic campaign status updates
